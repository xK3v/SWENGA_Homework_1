...
/**
 * Servlet implementation class SaveNewGame
 */
@WebServlet("/saveNewGame")
public class SaveNewGame extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!errorOccurred) {
			...
			if (game != null) {
				errorMessage += "Game already exists!<br>";
				errorOccurred = true;
			} else {
				GameModel gm = new GameModel(id, name, developer, releaseDate);
				gameService.addGame(gm);
			}
		}
		
		if (!errorOccurred) {
			request.setAttribute("message", "New game " + id + " added.");
